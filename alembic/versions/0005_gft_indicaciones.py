"""expose gft technical sheet indications

Revision ID: 0005_gft_indicaciones
Revises: 0004_cima_ficha_cache
"""
from alembic import op

revision = '0005_gft_indicaciones'
down_revision = '0004_cima_ficha_cache'
branch_labels = None
depends_on = None
