...
class GFTEstadoPresentacion(Base):
    ...
    nombre_comercial_importado: Mapped[str | None] = mapped_column(Text)
    principio_activo_importado: Mapped[str | None] = mapped_column(Text)
    presentacion_importada: Mapped[str | None] = mapped_column(Text)
    forma_farmaceutica_importada: Mapped[str | None] = mapped_column(Text)
